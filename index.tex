...
\begin{tcolorbox}[enhanced jigsaw, breakable, colback=white, toptitle=1mm, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, opacitybacktitle=0.6, colframe=quarto-callout-warning-color-frame, titlerule=0mm, bottomrule=.15mm, opacityback=0, rightrule=.15mm, toprule=.15mm, bottomtitle=1mm, coltitle=black, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Non-used codes}, arc=.35mm, leftrule=.75mm]
