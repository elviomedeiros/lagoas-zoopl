...
\hypersetup{
  ...
  pdfauthor={Marcela Vitória Bernardo da Silva; Mayara Mirelly da Silva Monteiro; Ellen Gomes da Silva; Ludmilla Cavalcanti Antunes Lucena; Elvio Sergio Figueredo Medeiros},
  pdflang={en-US},
  pdfkeywords={Heterogeneidade ambiental, Lagoa Temporária, Partição da
diversidade, Semiárido brasileiro, Zooplâncton},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\makeatother
\subtitle{Subtitle 1 OR Subtitle 2}
\author{Marcela Vitória Bernardo da Silva \and Mayara Mirelly da Silva
Monteiro \and Ellen Gomes da Silva \and Ludmilla Cavalcanti Antunes
Lucena \and Elvio Sergio Figueredo Medeiros}
\date{2026-09-02}
\begin{document}
\maketitle
\begin{abstract}
...
regiões semiáridas brasileiras (Medeiros et al., 2008; Melo \& Medeiros,
2013). Diante desse contexto, o presente estudo tem como objetivo
avaliar a estrutura da comunidade zooplanctônica e os padrões de
partição da diversidade em lagoas temporárias do semiárido brasileiro,
analisando a influência das variações ambientais associadas ao regime
hidrológico sazonal.
...
\item
  Quantificar as variações espaciais e temporais da diversidade
  zooplanctônica, decomposta em componentes α, β e γ, por meio da
  aplicação da partição aditiva e multiplicativa da diversidade em
  diferentes escalas espaciais.
\item
  Analisar a relação entre a estrutura da comunidade zooplanctônica e as
  variáveis ambientais físicas, químicas, estruturais e antrópicas,
  identificando os principais fatores associados à organização da
  diversidade e da composição de espécies.
\item
  Identificar espécies indicadoras da comunidade zooplanctônica
  associadas a diferentes condições ambientais e hidrológicas da lagoa
  temporária, com base em padrões de ocorrência e abundância.
\item
  Avaliar o potencial do zooplâncton como bioindicador do estado
  ecológico de ambientes aquáticos temporários, considerando respostas
  da diversidade, da estrutura comunitária e da composição de espécies
  às variações ambientais.
\item
  Caracterizar a composição taxonômica da comunidade zooplanctônica,
  visando compreender seus padrões de diversidade, variação espacial e
  temporal e os processos ecológicos que estruturam essa fauna em
...
\pandocbounded{\includegraphics[keepaspectratio]{imagens/pesquisa_cientifica.jpg}}
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacitybacktitle=0.6, colframe=quarto-callout-warning-color-frame, coltitle=black, arc=.35mm, toprule=.15mm, rightrule=.15mm, colback=white, toptitle=1mm, bottomtitle=1mm, bottomrule=.15mm, leftrule=.75mm, titlerule=0mm, opacityback=0, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Non-used codes}, colbacktitle=quarto-callout-warning-color!10!white, breakable]
